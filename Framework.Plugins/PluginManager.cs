...
namespace Framework.Plugins
{
    ...
    public class PluginManager
    {
        ...
        public static void Initialize(ApplicationPartManager applicationPartManager, IHostingEnvironment hostingEnvironment, FrameworkPluginOptions options)
        {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug, FrameworkPluginOptions options, string shadowCopyPath = "")
        {
        ...
        /// <param name="plug">Plugin file info</param>
        /// <returns></returns>
        private static Assembly RegisterPluginDefinition(FrameworkPluginOptions options, FileInfo plug)
        {
